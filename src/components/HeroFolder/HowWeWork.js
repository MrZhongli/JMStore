...
const HowWeWork = () => {
  ...
  <img src="https://impulsapopular.com/wp-content/uploads/2018/12/4300-Cinco-elementos-esenciales-para-una-agenda-productiva.jpg"  className="max-w-sm sm:w-80  rounded-lg shadow-2xl " />

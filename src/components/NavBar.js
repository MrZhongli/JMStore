    ...
    <div className="navbar ">
      <div className="navbar-start  ">
        ...
        <div className="dropdown md:block lg:hidden ">
          ...
          <ul tabIndex="0" className="menu menu-compact dropdown-content mt-3 -mx-2 shadow bg-gray-400 rounded-box  w-screen  h-96 column justify-center align-center m-auto ">
